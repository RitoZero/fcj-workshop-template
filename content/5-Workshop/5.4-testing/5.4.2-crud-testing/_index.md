...
![Create Task & Upload Image](/images/5-Workshop/5.4-testing/create-task.png)
...
![Task List View & Kanban Filters](/images/5-Workshop/5.4-testing/read-tasks-kanban.png)
...
![Updating Task Status via Drag-and-Drop](/images/5-Workshop/5.4-testing/update-task-kanban.png)
...
![Task Deletion Success](/images/5-Workshop/5.4-testing/delete-task.png)