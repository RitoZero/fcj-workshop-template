...
![Kiểm thử 401 Unauthorized trên Postman](/images/5-Workshop/5.4-testing/api-unauthorized-test.png)
...
![Kiểm thử 200 OK với JWT Token hợp lệ](/images/5-Workshop/5.4-testing/api-authorized-test.png)
...
![Xác minh Response Headers CORS](/images/5-Workshop/5.4-testing/cors-headers-verification.png)